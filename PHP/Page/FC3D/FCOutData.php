...
<section class="panel">
	<header class="panel-heading"> 频率统计 
	<ul class="nav pull-right top-menu">
	<li>
			<div class="col-lg-1">
               <i class="fa fa-calendar"></i>
               <input id="begindate" type="text"  value="2002-01-01" size="16">
            </div>
     </li>
	<li>
			<div class="col-lg-1">
               <i class="fa fa-calendar"></i>
               <input id="enddate" type="text"  value="2016-11-8" size="16">
            </div>
     </li>
     <li>
			<select class="form-control col-lg-1" size="1" >
