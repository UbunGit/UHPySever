...
class InterfaceManageVC extends BaseViewController
{
    ...
    function viewLoadbody()
    {
        ...
        $this->searchKey = isset ($_GET ["searchKey"]) ? $_GET ['searchKey'] : null;
    ...
    function getInterfaceList()
    {
        ...
        $request = $httpIntface->getInterfaceList($this->searchKey);
        if ($request) {
    ...
    function outInterFaceList($interFaceList)
    {
        ...
        <section class="panel">
            <div class="panel-body">
                <input type="text" placeholder="Keyword Search" class="form-control search-text"
                       value="<?php echo $this->searchKey; ?>">
            </div>
        </section>
        <section class="panel">
            <header class="panel-heading">
                接口列表(<?php echo count($interFaceList); ?> )<span class="tools pull-right"> <a
                            class="fa fa-plus addInterFace"> </a>
		</span>
            </header>
            <div class="panel-body">
                <ul class="nav prod-cat">
                    ...
                    if (!empty($interFaceList)) {
                        ...
                        foreach ($interFaceList as $value) {
                            ...
                            echo '<li>
<a href=./index.php?className=InterfaceManageVC&interFaceName=' . $value ['interFaceName'] . '>
<i class=" fa fa-leaf"></i>  ' . $value ['interFaceName'] . ' <small>' . $value ['interFaceNameStr'] . '</small></a> </li>';
                        }
                    }
                    ?>
                </ul>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-12">
                                    <select class="form-control  m-bot15 " name="interFacepath">
                                        <option
                                            <?php if (strcmp($baseinfo['interFacepath'], "interface") == 0) echo 'selected="selected"'; ?>>
                                            interface
                                        </option>
                                        <option
                                            <?php if (strcmp($baseinfo['interFacepath'], "samrtHome") == 0) echo 'selected="selected"'; ?>>
                                            samrtHome
                                        </option>
                                        <option
                                            <?php if (strcmp($baseinfo['interFacepath'], "FCAnalyse") == 0) echo 'selected="selected"'; ?>>
                                            FCAnalyse
                                        </option>
                                    </select>
                                </div>
